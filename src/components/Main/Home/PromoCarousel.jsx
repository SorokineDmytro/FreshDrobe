    ...
    <div className="relative h-65 md:h-80 lg:h-105">
      <div className=" w-full lg:max-w-[1270px] mx-auto overflow-hidden rounded-4xl">
              ...
              >
                ...
                >
                  ...
                  <div className="bg-white flex flex-col md:flex-row md:justify-between lg:flex-col items-center lg:items-start p-3 md:p-5 lg:p-7.5 md:rounded-b-4xl lg:rounded-4xl shadow-lg md:shadow-none w-full lg:max-w-md md:h-20 lg:h-[230px]">
                    <div className="hidden w-1/3 h-8 py-2 lg:flex items-center justify-center text-sm font-['Inter',sans-serif] font-bold bg-danger text-white rounded-full mb-3.5">
                      Promo 20%
                    </div>
        ...
        <button
          ...
          className="hidden lg:flex absolute top-4/9 left-5 w-12 h-12 -translate-y-1/2 items-center justify-center bg-white rounded-full hover:bg-primary hover:border-primary hover:text-white transition duration-300 ease-in-out shadow-sm"
        ...
        <button
          ...
          className="hidden lg:flex absolute top-4/9 right-5 w-12 h-12 -translate-y-1/2 items-center justify-center bg-white rounded-full hover:bg-primary hover:border-primary hover:text-white transition duration-300 ease-in-out shadow-sm"
