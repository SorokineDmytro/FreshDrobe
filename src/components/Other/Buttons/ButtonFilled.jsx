...
const ButtonFilled = ({ text, color = 'primary', height = '12', width = '50', image:Icon = ''}) => {
  ...
  return (
    <button className={`font-['Inter',sans-serif] font-bold text-[15px] rounded-4xl border-1 flex items-center justify-center ${bgColorClass} text-white ${heightClass} ${widthClass} duration-300 ease-in-out hover:opacity-75`}>
